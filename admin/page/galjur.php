                ...
                <div class="box-body p-0">
                    <div id="gallery-content">
                        ...
                        <div id='gallery-content-center'>
                            ...
                            while ($b = mysqli_fetch_assoc($sql)) {
                                echo "
                            <a href='../foto/galeri_jurusan/" . $b['foto_jur'] . "' data-toggle='lightbox' data-gallery='multiimages' data-title='Image title will be apear here'><img src='../foto/galeri_jurusan/" . $b['foto_jur'] . "' alt='gallery' class='all studio' /> </a>
                            ";
                            } ?></div>
                    </div>
                </div>
